...
\section{Первая теорема разложения}
...
Существует вторая, можно её почитать в~\cite[стр.~27]{Dubkov:Lecture}. На 26-й странице пример применения первой теоремы разложения при решении задачи.
...
Последняя задача -- интегральное уравнение. Там можно заметить интеграл типа ``свёртки'' $\int_0^t g(t-\tau)x(\tau)\rd\tau$. Если быть точным, перед нами уравнение Вольтерра второго рода.~\cite[см.~ф-лу~8.11]{integral-equations}
