...
\begin{enumerate}
	...
	\]
	\item Дифференцирование оригинала. $f\in C^n$
	\begin{align*}
...
\]
физическая интерпретация~\cite{Plancherel}: \emph{энергия колебательного сигнала равна сумме энергий его гармонических компонент.}
